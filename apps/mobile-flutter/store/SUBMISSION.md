...
Create four one-time managed products. The identifiers must match `PLAY_PRODUCTS` in `/opt/secretmsg/secretmsg-private/api/src/billing.ts:7-12` and `BillingProducts` in `apps/mobile-flutter/lib/api/billing.dart:10-21` exactly.
