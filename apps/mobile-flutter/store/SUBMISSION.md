...
- [ ] **Upload keystore:** generate, configure, back up, and use the release upload key. `android/key.properties` is gitignored; without it, Gradle falls back to the debug signing key at `android/app/build.gradle:209`.
