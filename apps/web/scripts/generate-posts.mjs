...
const FEATURE_PITCH = {
  ...
  supporters: [
    ...
    'The app is ad-supported, and one Play purchase removes the ads. Play purchases are verified server-side before anything is granted — no client-side unlocks.',
  ],
  app: [
...
const TOPICS = [
  ...
  },
  {
    ...
    secs: [
      ...
      ['How backing works', ['The app is free and ad-supported. Android purchases use Google Play Billing, and the server verifies the purchase token before granting anything. A single one-time purchase removes the ads for good, and the grant is applied server-side.', 'The available checkout and the exact grant vary by path. Do not treat a supporter badge, custom handle, or hint as automatically included in every contribution; check the current checkout and your account settings.']],
    ],
  },
  {
  ...
  },
  {
    ...
    secs: [
      ...
      ['Monetizing honesty', ['Supporter contributions fund the project through ad revenue and optional ad-removal purchases. The purchase is what grants something: a single one-time unlock removes the ads, and the app does not automatically give extras to top fans or mods.', 'The supporters page reports how many accounts hold the ad-free purchase, without naming anyone. Treat it as aggregate information, not a promise of sponsor reach or a guaranteed conversion result.']],
