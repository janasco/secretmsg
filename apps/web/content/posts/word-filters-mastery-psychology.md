...
Safety tooling nobody can find might as well not exist. So here is the complete, plain-language tour of word filters, mastered — where it lives, when to reach for it, and what happens next.
